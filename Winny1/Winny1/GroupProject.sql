...
exec spAboutCrud @crud = 'c',
			     @aboutTitle = 'Monthly Average Temperatures:',
			     @aboutDescription = ' '

exec spAboutCrud @crud = 'c',
			     @aboutTitle = 'January',
			     @aboutDescription = 'High: -10 C,  Low: -20 C'
				  
exec spAboutCrud @crud = 'c',
			     @aboutTitle = 'February',
			     @aboutDescription = 'High:  -8 C,  Low: -18 C'

exec spAboutCrud @crud = 'c',
			     @aboutTitle = 'March',
			     @aboutDescription = 'High:   0 C,  Low: -11 C'

exec spAboutCrud @crud = 'c',
			     @aboutTitle = 'April',
			     @aboutDescription = 'High:  10 C,  Low:  -2 C'

exec spAboutCrud @crud = 'c',
			     @aboutTitle = 'May',
			     @aboutDescription = 'High:  18 C,  Low:   5 C'

exec spAboutCrud @crud = 'c',
			     @aboutTitle = 'June',
			     @aboutDescription = 'High:  23 C,  Low:  12 C'

exec spAboutCrud @crud = 'c',
			     @aboutTitle = 'July',
			     @aboutDescription = 'High:  26 C,  Low:  14 C'

exec spAboutCrud @crud = 'c',
			     @aboutTitle = 'August',
			     @aboutDescription = 'High:  26 C,  Low:  13 C'

exec spAboutCrud @crud = 'c',
			     @aboutTitle = 'September',
			     @aboutDescription = 'High:  20 C,  Low:   8 C'

exec spAboutCrud @crud = 'c',
			     @aboutTitle = 'October',
			     @aboutDescription = 'High:  11 C,  Low:   1 C'

exec spAboutCrud @crud = 'c',
			     @aboutTitle = 'November',
			     @aboutDescription = 'High:   1 C,  Low:  -8 C'

exec spAboutCrud @crud = 'c',
			     @aboutTitle = 'December',
			     @aboutDescription = 'High:  -8 C,  Low: -17 C'
...
--	AvgLow varchar(10)
--)
--insert into tbWeatherAverages (Month, AvgHigh, AvgLow) values
--	('January','-10 C','-20 C'),
--	('February','-8 C','-18 C'),
--	('March','0 C','-11 C'),
--	('April','10 C','-2 C'),
...
--create procedure spReadWeatherAverages
--(
--	@weatherID int = null,
--	@month varchar(15),
--	@highAvg varchar(10),
...
--)
--as begin
--	select Month, AvgHigh, AvgLow from tbWeatherAverages where WeatherId=isnull(@weatherId,WeatherId)
--end

--select * from tbWeatherAverages
--go
