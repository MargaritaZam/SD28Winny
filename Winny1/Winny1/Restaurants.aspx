...
div.desc {
    ...
    <asp:Panel ID="Panel1" runat="server"  Height="1500px" Width="600px" BackColor="White">
<div class="gallery">
...
<table>
    ...
    <tr>
        ...
        <asp:DataList ID="dlRestaurant" RepeatColumns="5" RepeatDirection="Horizontal" runat="server">
        <ItemTemplate>
            <div id="mydiv"  onclick="return ViewProduct(<%#Eval ("RestaurantId")%>)"  style="height:380px;">
                <table style="width:250px; ">
                    ...
                    <tr style="height:45px;" >
                        <td style="text-align:center; vertical-align:text-top"> <%# Eval ("name")%></td>
                    </tr>
